const textConfig = {
  ...
  text8: "Submit assignment",
  text9: "Vì anh là anh",
  text10: "Xin cảm ơn những lời nhận xét của em.",
  text11: "Mấy hôm tới mình đi chơi nhá =)))",
  text12: "Xin chân thành cảm ơn 270101 lần",
};
...
$(document).ready(function () {
  ...
  $("#yes").click(function () {
    ...
    Swal.fire({
      ...
      width: 900,
      padding: "3em",
      html: "<input type='text' class='form-control' id='txtReason'  placeholder='Xấu thế nào đẹp ra sao'>",
      background: '#fff url("img/iput-bg.jpg")',
      backdrop: `
                    rgba(0,0,123,0.4)
                    url("img/giphy2.gif")
